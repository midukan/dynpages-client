...
export class CidadePageService extends PageService {
  ...
  async modalForm(filtersSelectDatas?: FiltersSelectDatas, centroCusto?: any): Promise<any> {

  }

  async navigate(filtersSelectDatas?: FiltersSelectDatas, centroCusto?: any): Promise<boolean> {
